...
<div class="footer-area">
    <div class="footer-top section-space-y-axis-100 text-lavender" data-bg-image="{{ asset('motoconexion/assets/images/background-img/1-4-1920x419.png')}}">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <div class="widget-item">
                        <div class="footer-logo pb-4">
                            <a href="index.html">
                                <img src="{{ asset('motoconexion/assets/images/logo/light.png')}}" alt="Logo">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 pt-8 pt-lg-0">
                    ...
                    <div class="payment-method">
                        <a href="#">
                            <img src="{{ asset('motoconexion/assets/images/payment/1.png')}}" alt="Payment Method">
                        </a>
                    </div>
                </div>
            </div>
